      ...
      <DialogContent width={"100%"} sx={styles.dialogBg}>
        {isOpen ? (
          ...
          <div>
            ...
            <TextField fullWidth placeholder="Enter Mobile Number" variant="filled" value={number} onChange={(event) => setNumber(event.target.value)} hiddenLabel style={{ backgroundColor: "white", borderRadius: 22 }} size="small" InputProps={{ startAdornment: <InputAdornment position="start">+91</InputAdornment>, disableUnderline: true }} />
