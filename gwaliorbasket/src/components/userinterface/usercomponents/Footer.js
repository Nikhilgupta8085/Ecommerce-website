  ...
  return (
    <>
      ...
      <Grid container spacing={3} py={3} gap={3} justifyContent="center">
        ...
        <Grid item xs={12} md={3}>
        <Box bgcolor="white" sx={{ boxShadow: "0 5px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)" }} display="flex" textAlign={!matches ? "center" : "left"} flexDirection={!matches ? "column" : "row"} alignItems="center" gap={matches ? 2 : 4} p={2} py={!matches ? 6 : 2}>
            <img src="/assets/f2.svg" width={80} />
            <div>
              <b>Don’t Blink</b>
              <div style={{ fontSize: 14, color: "gray" }}>Our delivery partner will be at your door essentials.</div>
            </div>
          </Box>
        ...
        <Grid item xs={12} md={3}>
          <Box bgcolor="white" sx={{ boxShadow: "0 5px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)" }} display="flex" textAlign={!matches ? "center" : "left"} flexDirection={!matches ? "column" : "row"} alignItems="center" gap={matches ? 2 : 4} p={2} py={!matches ? 6 : 2}>
            <img src="/assets/f3.svg" width={80} />
            <div>
              <b>Enjoy</b>
      ...
      <Grid container py={4} >
        ...
        <Grid item xs={12} md={3}>
          <p>Download App</p>
          <Box display="flex" alignItems="center" fontSize={14} gap={1} border="1px solid gray" p={1} justifyContent="center" borderRadius={2}>
            <AppleIcon /> <span>Get it on app store</span>
          </Box>
          <Box mt={2} display="flex" alignItems="center" fontSize={14} gap={1} border="1px solid gray" p={1} justifyContent="center" borderRadius={2}>
